    ...
    <div class="container">
        <div class="call-to-action">
            <div class="section-heading heading-light">
                <span class="subtitle" style="font-style: bold">ما آماده شروع همکاری هستیم</span>
                <h2 class="title">آیا به یک پروژه موفق نیاز دارید </h2>
                <a href="contact.html" class="axil-btn btn-large btn-fill-white">درخواست همکاری</a>
            </div>
            <div class="thumbnail">
